...
export function About() {
  ...
  const bio: string =
    "I do web, game development, and sometimes a combination of those two. I'm currently looking for software-focused roles where I can keep growing, take on interesting challenges, and meet amazing people.";
  ...
  return (
    <>
      <section
        id="About"
        className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-3 mb-90"
      >
        <div className="text-left lg:mt-75 mb-20 w-full">
          <h1 className=" mb-2 text-xl font-extrabold tracking-tight leading-none text-gray-400 md:text-3xl lg:text-4xl dark:text-gray-400">
            {name}
          </h1>

          <div className="flex items-center gap-2 mb-5">
            <h2 className="text-l font-extrabold tracking-tight leading-none text-gray-900 md:text-xl lg:text-2xl">
              <strong className="text-cyan-700">{role}</strong>
            </h2>
            <svg
              ...
              stroke-width="1.5"
              stroke="currentColor"
              className="w-5 h-5 text-gray-700 dark:text-gray-300 dark:stroke-gray-300"
            >
              <path
            ...
            <span className="text-gray-700 dark:text-gray-300 text-l lg:text-xl">
              {location}
            </span>
          </div>

          <p className="mb-8 text-sm text-gray-500 lg:text-xl md:text-lg dark:text-gray-300 max-w-xl break-words text-left">
            {bio}
          </p>
              ...
              <div className="flex flex-wrap items-center text-gray-500">
                ...
                >
                  <svg
                    ...
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    id="Brand-Bluesky--Streamline-Tabler"
                    height="50"
                    width="50"
                  >
                    <desc>
                ...
                <a
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://github.com/0x008080"
                  className="mr-5 mb-5 lg:mb-0"
                >
                  <svg
                    className="logo-3"
                ...
                <a
                  href="#Projects"
                  className="inline-flex justify-center items-center py-3 px-5 text-base font-medium rounded-lg border border-gray-300 focus:ring-4 focus:ring-gray-100 dark:text-gray-300 dark:border-gray-400 logo-3 dark:focus:ring-gray-800"
                >
                  Learn More
                </a>
              </div>
