...
export function About() {
    ...
    return (
        <>
            <section className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-5">
                <div className="font-serif text-left lg:mt-130 w-full">
                    <h1 className=" mb-2 text-2xl font-extrabold tracking-tight leading-none text-gray-400 md:text-4xl lg:text-4xl dark:text-gray-400">{name}</h1>
                    ...
                    <p className="mb-8 text-md font-serif text-gray-500 lg:text-lg dark:text-gray-300 max-w-xl break-words text-left">{bio}</p>
                    
                    <div className="flex-1 mb-8 lg:mb-16 space-y-4 sm:justify-center sm:space-y-0 sm:space-x-4">
