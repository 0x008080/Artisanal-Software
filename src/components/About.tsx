...
export function About() {
    ...
    return (
        <>
            <section className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-5 mb-85">
                <div className="font-serif text-left lg:mt-130 w-full">
                    <h1 className=" mb-2 text-2xl font-extrabold tracking-tight leading-none text-gray-400 md:text-4xl lg:text-6xl dark:text-gray-400">{name}</h1>

                    <div className="flex items-center gap-2 mb-5">
                        <h2 className="text-xl font-extrabold tracking-tight leading-none text-gray-900 md:text-2xl lg:text-3xl"><strong
