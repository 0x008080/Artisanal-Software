            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="font-serif py-10 px-4 md:px-8 shadow-md shadow-xl/10 rounded-lg lg:h-screen lg:place-content-center">
                    ...
                    <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                        <a href="#" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-500 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-800 dark:focus:ring-gray-800">
                            About
                        </a>
                    </div>
